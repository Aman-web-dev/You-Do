...
const AuthPage = () => {
  ...
  const googleAuthpage =`https://accounts.google.com/o/oauth2/v2/auth?scope=https%3A//www.googleapis.com/auth/drive.metadata.readonly%20https%3A//www.googleapis.com/auth/calendar.readonly&include_granted_scopes=true&response_type=token&redirect_uri=http://localhost:3000/api/auth/google&client_id=${GOOGLE_CLIENT_ID}`
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20 p-8">
          ...
          <div className="space-y-6">
            ...
            <button
              type="button"
              onClick={()=>activeTab==="signup"?signup(formData):login(formData)}
          ...
          <div className="space-y-3">
            <button onClick={()=>{window.location.href=googleAuthpage}} className="w-full flex items-center justify-center py-3 px-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors duration-200">
